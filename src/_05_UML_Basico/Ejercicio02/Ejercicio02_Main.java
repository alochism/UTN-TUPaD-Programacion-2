...
public class Ejercicio02_Main {
    ...
    public static void main(String[] args) {
        ...
        celu1.setUsuario(usuario1);
        celu1.setBateria(bata1);
     
        
        // Muestro relaciones
        System.out.println("El usaurio " + celu1.getUsuario().getNombre() + ", DNI: " + celu1.getUsuario().getDni() + ", tiene un celular marca " + usuario1.getCelular().getMarca() + ", con batería de ");
        usuario1.setCelular(celu1);
        System.out.println(usuario1.getCelular().getMarca());
